...
import { getCallConfigSummary } from './helpers/get-call-config-summary'
...
export function* generate(app: AlgoAppSpec): DocumentParts {
  ...
  const callConfigSummary = getCallConfigSummary(app)
  ...
  yield NewLine
  yield* deployTypes(app, callConfigSummary)

  // Write a call factory
  yield* callFactory(app)
  yield NewLine
  // Write a client
  yield* callClient(app, callConfigSummary)
}
