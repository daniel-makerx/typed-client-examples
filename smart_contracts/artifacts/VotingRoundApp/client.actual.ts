...
export abstract class VotingRoundAppCallFactory {
  static create(args: CreateArgsObj, params: AppClientCallCoreParams & AppClientCompilationParams = {}): CallRequest<void, CreateArgsTuple>  {
    return {
      method: 'create(string,byte[],string,uint64,uint64,uint8[],uint64,string)void',
      methodArgs: [args.vote_id,args.snapshot_public_key,args.metadata_ipfs_cid,args.start_time,args.end_time,args.option_counts,args.quorum,args.nft_image_url],
      ...params,
    }
  }
  static bootstrap(args: BootstrapArgsObj, params: AppClientCallCoreParams & AppClientCompilationParams = {}): CallRequest<void, BootstrapArgsTuple>  {
    return {
      method: 'bootstrap(pay)void',
      methodArgs: [args.fund_min_bal_req],
      ...params,
    }
  }
  static close(args: CloseArgsObj, params: AppClientCallCoreParams & AppClientCompilationParams = {}): CallRequest<void, CloseArgsTuple>  {
    return {
      method: 'close()void',
      methodArgs: [],
      ...params,
  ...
  static getPreconditions(args: GetPreconditionsArgsObj, params: AppClientCallCoreParams & AppClientCompilationParams = {}): CallRequest<(uint64,uint64,uint64,uint64), GetPreconditionsArgsTuple>  {
    return {
      method: 'get_preconditions(byte[])(uint64,uint64,uint64,uint64)',
      methodArgs: [args.signature],
      ...params,
    }
  }
  static vote(args: VoteArgsObj, params: AppClientCallCoreParams & AppClientCompilationParams = {}): CallRequest<void, VoteArgsTuple>  {
    return {
      method: 'vote(pay,byte[],uint8[])void',
      methodArgs: [args.fund_min_bal_req,args.signature,args.answer_ids],
      ...params,
    }
  }
}
...
export class VotingRoundAppClient {
  ...
  public create(args: CreateArgsObj, params?: AppClientCallCoreParams & AppClientCompilationParams) {
    return this.call(VotingRoundAppCallFactory.create(args, params))
  }

  public bootstrap(args: BootstrapArgsObj, params?: AppClientCallCoreParams & AppClientCompilationParams) {
    return this.call(VotingRoundAppCallFactory.bootstrap(args, params))
  }

  public close(args: CloseArgsObj, params?: AppClientCallCoreParams & AppClientCompilationParams) {
    return this.call(VotingRoundAppCallFactory.close(args, params))
  }

  public getPreconditions(args: GetPreconditionsArgsObj, params?: AppClientCallCoreParams & AppClientCompilationParams) {
    return this.call(VotingRoundAppCallFactory.getPreconditions(args, params))
  }

  public vote(args: VoteArgsObj, params?: AppClientCallCoreParams & AppClientCompilationParams) {
  ...
  public create(args?: VotingRoundAppCreateArgs, params?: AppClientCallCoreParams & AppClientCompilationParams & CoreAppCallArgs) {
