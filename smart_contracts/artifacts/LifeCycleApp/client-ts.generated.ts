...
export abstract class LifeCycleAppCallFactory {
  ...
  static create_1arg(args: Create_1argArgs, params: AppClientCallCoreParams & CoreAppCallArgs = {}): CallRequest<void, Create_1argArgsTuple>  {
    return {
...
export class LifeCycleAppClient {
  ...
  /**
   * Calls the create_1arg(string)void ABI method.
   *
   * @param args The arguments for the ABI method
   * @param params Any additional parameters for the call
   * @returns The result of the call
