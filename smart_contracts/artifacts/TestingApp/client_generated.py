...
class TestingAppClient:
    ...
    def set_global(
        ...
        *,
        ...
        args = SetGlobalArgs(int1=int1,int2=int2,bytes1=bytes1,bytes2=bytes2,)
        return self.app_client.call(
            call_abi_method=args.method(),
            transaction_parameters=_convert(transaction_parameters),
            **_as_dict(args),
    ...
    def set_local(
        ...
        *,
        ...
        args = SetLocalArgs(int1=int1,int2=int2,bytes1=bytes1,bytes2=bytes2,)
        return self.app_client.call(
            call_abi_method=args.method(),
            transaction_parameters=_convert(transaction_parameters),
            **_as_dict(args),
    ...
    def set_box(
        ...
        *,
        ...
        args = SetBoxArgs(name=name,value=value,)
        return self.app_client.call(
            call_abi_method=args.method(),
            transaction_parameters=_convert(transaction_parameters),
            **_as_dict(args),
