...
export type TestingAppCreateArgs =
  | BareCallArgs
  | ({ method: 'create_abi' } & CreateAbiArgsObj)
...
export class TestingAppClient {
  ...
  public deploy(params: TestingAppDeployArgs & AppClientDeployCoreParams = {}) {
    return this.appClient.deploy({ 
      ...
      updateArgs: params.updateArgs && this.mapMethodArgs(params.updateArgs),
      deleteArgs: params.deleteArgs && this.mapMethodArgs(params.deleteArgs),
    })
  }
