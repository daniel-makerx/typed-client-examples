...
export class TestingAppClient {
  ...
  private mapDeployMethodArgs(args: TestingAppCreateArgs | TestingAppUpdateArgs | TestingAppDeleteArgs, params?: CoreAppCallArgs): AppClientCallArgs {
    switch (args.method) {
      case 'create_abi':
  ...
  public deploy(params: TestingAppDeployArgs & AppClientDeployCoreParams = {}) {
    ...
    return this.appClient.deploy({ 
      ...params,
      createArgs: params.createArgs ? this.mapDeployMethodArgs(createArgs, { boxes: create_boxes, lease: create_lease }) : undefined,
      createOnCompleteAction,
      updateArgs: params.updateArgs ? this.mapDeployMethodArgs(updateArgs, { boxes: update_boxes, lease: update_lease }) : undefined,
      deleteArgs: params.deleteArgs ? this.mapDeployMethodArgs(deleteArgs, { boxes: delete_boxes, lease: delete_lease }) : undefined,
    })
  }
  ...
  public create<TMethod extends string>(args: { method?: TMethod } & TestingAppCreateArgs = {}, params?: AppClientCallCoreParams & AppClientCompilationParams & CoreAppCallArgs) {
    ...
    return this.mapReturnValue<TMethod>(this.appClient.create({ ...this.mapDeployMethodArgs(args), ...params, ...{ onCompleteAction } }))
  }
  ...
  public update<TMethod extends string>(args: { method?: TMethod } & TestingAppUpdateArgs = {}, params?: AppClientCallCoreParams & AppClientCompilationParams & CoreAppCallArgs) {
    return this.mapReturnValue<TMethod>(this.appClient.update({ ...this.mapDeployMethodArgs(args), ...params, }))
  }
  ...
  public delete<TMethod extends string>(args: { method?: TMethod } & TestingAppDeleteArgs = {}, params?: AppClientCallCoreParams & CoreAppCallArgs) {
    return this.mapReturnValue<TMethod>(this.appClient.delete({ ...this.mapDeployMethodArgs(args), ...params, }))
  }

  private mapMethodArgs(args: TestingAppOptInArgs): AppClientCallArgs {
    switch (args.method) {
      case 'opt_in':
  ...
  /**
   * Makes an opt_in call to an existing instance of the TestingApp smart contract.
   * @param args The arguments for the contract call
   * @param params Any additional parameters for the call
   * @returns The opt_in result
   */
  public optIn<TMethod extends string>(args: { method?: TMethod } & TestingAppOptInArgs, params?: AppClientCallCoreParams & CoreAppCallArgs) {
    return this.mapReturnValue<TMethod>(this.appClient.optIn({ ...this.mapMethodArgs(args), ...params, }))
  }
